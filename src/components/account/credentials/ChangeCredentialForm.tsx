          ...
          <label>
            ...
            <div className="input_group">
              ...
              <button
                ...
                tabIndex={-1}
                onClick={() => {
                  setCurrPwdVisible((curr) => !curr);
                }}
              >
                {!currPwdVisible ? <FiEye /> : <FiEyeOff />}
                <span className="tooltip_text">
                  {!currPwdVisible ? "Show password" : "Hide password"}
                </span>
              </button>
            </div>
          </label>
          <label>
            ...
            <div className="input_group">
              ...
              <button
                ...
                tabIndex={-1}
                onClick={() => {
                  setNewPwdVisible((curr) => !curr);
                }}
              >
                {!newPwdVisible ? <FiEye /> : <FiEyeOff />}
                <span className="tooltip_text">
                  {!newPwdVisible ? "Show password" : "Hide password"}
                </span>
              </button>
            </div>
          </label>
          <label>
            ...
            <div className="input_group">
              ...
              <button
                ...
                tabIndex={-1}
                onClick={() => {
                  setConfirmPwdVisible((curr) => !curr);
                }}
              >
                {!confirmPwdVisible ? <FiEye /> : <FiEyeOff />}
                <span className="tooltip_text">
                  {!confirmPwdVisible ? "Show password" : "Hide password"}
                </span>
              </button>
            </div>
          </label>
